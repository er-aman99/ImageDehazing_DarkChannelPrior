...
img = imread('D:\Quick Access\Desktop\dip\Single-image-dehazing-using-a-multilayer-perceptron-master\Single-image-dehazing-using-a-multilayer-perceptron-master\images\pp.png');
[x, y, ~] = size(img);
...
A = double(A);
img = double(img);
w = 0.95;    %for making image look like real
